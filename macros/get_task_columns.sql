...
{% set columns = [
    ...
    {"name": "calldisposition", "datatype": dbt.type_string()},
    {"name": "call_duration_in_seconds", "datatype": dbt.type_int()},
    {"name": "calldurationinseconds", "datatype": dbt.type_int()},
    {"name": "call_object", "datatype": dbt.type_string()},
    {"name": "callobject", "datatype": dbt.type_string()},
    {"name": "call_type", "datatype": dbt.type_string()},
    {"name": "calltype", "datatype": dbt.type_string()},
    {"name": "completed_date_time", "datatype": dbt.type_timestamp()},
    {"name": "completeddatetime", "datatype": dbt.type_timestamp()},
    ...
    {"name": "is_closed", "datatype": dbt.type_boolean()},
    {"name": "isclosed", "datatype": dbt.type_boolean()},
    {"name": "is_deleted", "datatype": dbt.type_boolean()},
    {"name": "isdeleted", "datatype": dbt.type_boolean()},
    {"name": "is_high_priority", "datatype": dbt.type_boolean()},
    {"name": "ishighpriority", "datatype": dbt.type_boolean()},
    ...
    {"name": "tasksubtype", "datatype": dbt.type_string()},
