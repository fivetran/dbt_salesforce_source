...
{% set columns = [
    ...
    {"name": "description", "datatype": dbt.type_string(), "alias": "opportunity_line_item_description"},
    ...
    {"name": "id", "datatype": dbt.type_string(), "alias": "opportunity_line_item_id"},
    ...
    {"name": "name", "datatype": dbt.type_string(), "alias": "opportunity_line_item_name"},
