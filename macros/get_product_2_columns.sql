...
{% set columns = [
    ...
    {"name": "description", "datatype": dbt.type_string(), "alias": "product_2_description"},
    {"name": "display_url", "datatype": dbt.type_string()},
    {"name": "external_id", "datatype": dbt.type_string()},
    {"name": "family", "datatype": dbt.type_string()},
    {"name": "id", "datatype": dbt.type_string(), "alias": "product_2_id"},
    ...
    {"name": "name", "datatype": dbt.type_string(), "alias": "product_2_name"},
