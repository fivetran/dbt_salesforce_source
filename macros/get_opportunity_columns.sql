...
{% set columns = [
    ...
    {"name": "description", "datatype": dbt.type_string(), "alias": "opportunity_description"},
    ...
    {"name": "id", "datatype": dbt.type_string(), "alias": "opportunity_id"},
    ...
    {"name": "name", "datatype": dbt.type_string(), "alias": "opportunity_name"},
