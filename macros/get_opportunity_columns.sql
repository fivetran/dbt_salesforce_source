...
{% set columns = [
    ...
    {"name": "has_open_activity", "datatype": dbt.type_boolean()},
    {"name": "hasopenactivity", "datatype": dbt.type_boolean()},
    {"name": "has_opportunity_line_item", "datatype": dbt.type_boolean()},
    {"name": "hasopportunitylineitem", "datatype": dbt.type_boolean()},
    {"name": "has_overdue_task", "datatype": dbt.type_boolean()},
    {"name": "hasoverduetask", "datatype": dbt.type_boolean()},
    ...
    {"name": "is_won", "datatype": dbt.type_boolean()},
    {"name": "iswon", "datatype": dbt.type_boolean()},
