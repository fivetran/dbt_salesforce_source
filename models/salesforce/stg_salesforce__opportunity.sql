...
final as (
    ...
    select 
        ...
        fiscal,
        {{ coalesce_w_renamed_col('fiscal_quarter', datatype=dbt.type_int()) }},
        {{ coalesce_w_renamed_col('fiscal_year', datatype=dbt.type_int()) }},
        {{ coalesce_w_renamed_col('forecast_category') }},
        {{ coalesce_w_renamed_col('forecast_category_name') }},
        {{ coalesce_w_renamed_col('has_open_activity', datatype=dbt.type_boolean()) }},
        {{ coalesce_w_renamed_col('has_opportunity_line_item', datatype=dbt.type_boolean()) }},
        {{ coalesce_w_renamed_col('has_overdue_task', datatype=dbt.type_boolean()) }},
        ...
        {{ coalesce_w_renamed_col('is_won', datatype=dbt.type_boolean()) }},
