...
final as (
    ...
    select 
        ...
        id as lead_id,
        {{ coalesce_w_renamed_col('annual_revenue') }},
        city,
        company,
        ...
        {{ coalesce_w_renamed_col('has_opted_out_of_email') }},
        {{ coalesce_w_renamed_col('individual_id') }},
        industry,
        {{ coalesce_w_renamed_col('is_converted') }},
        {{ coalesce_w_renamed_col('is_deleted') }},
        {{ coalesce_w_renamed_col('is_unread_by_owner') }},
        ...
        name as lead_name,
        {{ coalesce_w_renamed_col('number_of_employees') }},
