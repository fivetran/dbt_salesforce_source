...
final as (
    ...
    select 
        ...
        {{ coalesce_w_renamed_col('number_of_quantity_installments', datatype=dbt.type_int()) }},
        {{ coalesce_w_renamed_col('number_of_revenue_installments', datatype=dbt.type_int()) }},
